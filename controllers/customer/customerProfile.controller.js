...
const customerProfileService = require("../../services/profile/customerProfile.service.js");
...
const deleteAddress = asyncWrapper(async (req, res) => {
  await customerProfileService.deleteAddress(req.user.id, req.params.addressId);
